...
public class ChangePrefixCommand extends CommandBase {
	...
	public String getCommandUsage(ICommandSender sender) {
		return "Usage: /changeprefix \"Enter prefix here\": Changes your prefix! (Client-side)";
	}
	...
	public void processCommand(ICommandSender sender, String[] args) throws CommandException {
		...
		NameChanger.P_PREFIX = name;
		NameChanger.instance.setConfiguration("PlayerPrefix", name);
